...
--
-- Hôte : localhost:8889
-- Généré le : mer. 28 fév. 2024 à 17:40
...
--
-- Base de données : `grandangletest`
--
...
CREATE TABLE `artiste` (
  ...
  `Email_Artiste` varchar(150) NOT NULL,
  `id_DirArt` int(11) DEFAULT NULL,
  `tel_Artiste` varchar(50) DEFAULT NULL
...
INSERT INTO `artiste` (`Id_Artiste`, `Nom_Artiste`, `Prenom_Artiste`, `Email_Artiste`, `id_DirArt`, `tel_Artiste`) VALUES
(1, 'Darroudi', 'Iran', '', 3, ''),
(2, 'Attar', 'Abbas', '', 3, ''),
(3, 'Neyestani', 'Mana', 'mana.neyestani@gmail.com', NULL, '06 52 45 87 54'),
(4, 'Neshat', 'Shirin', 'shirin.neshat@gmail.com', NULL, '06 52 45 77 54'),
(5, 'Walker', 'Kara', 'kara.walker@gmail.com', NULL, '06 52 45 67 54'),
(6, 'Yu', 'Chang', '', 2, ''),
(7, 'Zao', 'Wou-Ki', '', 2, ''),
(8, 'Murakami', 'Takashi', 'takashi.murakami@gmail.com', NULL, '06 23 45 67 54'),
(9, 'Orlinski', 'Richard', 'richard.orlinski@gmail.com', NULL, '06 52 65 67 54'),
(10, 'Tanavoli', 'Parviz', '', 1, ''),
(11, 'Chabert', 'Pierre-Jean', 'pierrejean.chabert@gmail.com', NULL, '06 02 65 67 54'),
(12, 'Freud', 'Lucian', '', 3, ''),
(13, 'Koons', 'Jeff', 'jeff.koons@gmail.com', NULL, '06 52 65 67 34'),
(15, 'Sattouf', 'Riad', 'riad.sattouf@gmail.com', NULL, '06 52 65 67 64'),
(16, 'Satrapi', 'Marjan', 'marjan.satrapi@gmail.com', NULL, '06 52 65 67 44'),
(17, 'Deghati', 'Reza', '', 1, ''),
(18, 'Golestan', 'Kave', '', 1, ''),
(19, 'Novin', 'Guity', '', 1, ''),
(20, 'Messager', 'Annette', 'annette.messager@gmail.com', NULL, '06 52 85 67 44'),
(21, 'Kusama', 'Yayoi', 'kusama.yayoi@gmail.com', NULL, '06 52 55 67 44'),
(22, 'Mohasses', 'Bahman', '', 1, ''),
(23, 'Sierra', 'Santiago', 'santiago.sierra@gmail.com', NULL, '06 52 15 67 44'),
...
CREATE TABLE `audio` (
  ...
  `libelle_Audio` varchar(50) DEFAULT NULL,
  `chemin_Audio` varchar(255) DEFAULT NULL,
  `libelle_Langue` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `bio_artist` (
  `Id_bio` int(11) NOT NULL,
  `description_artist` text,
  `chemin_Imgart` varchar(255) DEFAULT NULL,
...
CREATE TABLE `collaborateur` (
  ...
  `Nom_Collaborateur` varchar(80) NOT NULL,
  `prenom_Collaborateur` varchar(80) NOT NULL,
  `Email_Collaborateur` varchar(80) NOT NULL,
  `Pass_Collaborateur` varchar(30) NOT NULL,
...
INSERT INTO `collaborateur` (`id_Collaborateur`, `Nom_Collaborateur`, `prenom_Collaborateur`, `Email_Collaborateur`, `Pass_Collaborateur`, `Id_Service`, `roles`) VALUES
(1, 'Tavard', 'Jean pierre', 'jeanpierre.tavard@grandangle.fr', 'Jt2025&t', 1, '[‘’ADMIN’’,’’USER’’]'),
(2, 'Lecourt', 'Victoria', 'victoria.lecourt@grandangle.fr', 'Vl2024!t', 2, '[’’USER’’]'),
(3, 'Dubrac', 'Gabriel', 'gabriel.dubrac@grandangle.fr', 'Gd2023%t', 3, '[’’USER’’]'),
(4, 'Loup', 'Julie', 'julie.loup@grandangle.fr', 'Jl2022&t', 4, '[’’USER’’]'),
(5, 'Bazin', 'Alya', 'alya.bazin@grandangle.fr', 'Ab2021!t', 4, '[’’USER’’]'),
(6, 'Dupond', 'Claire', 'claire.dupond@grandangle.fr', 'Cd2020%t', 4, '[’’USER’’]'),
(7, 'Martin', 'Anna', 'anna.martin@grandangle.fr', 'Am2019&t', 4, '[’’USER’’]'),
(8, 'Luciani', 'Clara', 'clara.luciani@grandangle.fr', 'Cl2018!t', 5, '[’’USER’’]'),
(9, 'Thomas', 'Nicolas', 'nicolas.thomass@grandangle.fr', 'Nt2017%t', 5, '[’’USER’’]'),
(10, 'Herve', 'Jean', 'jean.herve@grandangle.fr', 'Jh2016&t', 5, '[’’USER’’]'),
(11, 'Duval', 'Sarah', 'sarah.duval@grandangle.fr', 'Sd2015!t', 5, '[’’USER’’]'),
(12, 'Schneider', 'Alex', 'alex.schneider@grandangle.fr', 'As2014%t', 6, '[’’USER’’]'),
(13, 'Holmes', 'Sherlock', 'sherlock.holmes@grandangle.fr', 'Sh2013&t', 6, '[’’USER’’]'),
(14, 'Ahmadi', 'Shadi', 'ahmadi.shadi@grandangle.fr', 'As2012!t', 6, '[’’USER’’]'),
(15, 'Lee', 'Huan', 'huan.lee@grandangle.fr', 'Hl2011%t', 6, '[’’USER’’]'),
(16, 'Baron', 'Goli', 'goli.baron@grandangle.fr', 'Gb2010&t', 6, '[’’USER’’]'),
(17, 'Ming', 'Julie', 'julie.ming@grandangle.fr', 'Jm2009!t', 6, '[’’USER’’]'),
(18, 'Moulin', 'Jean', 'jean.moulin@grandangle.fr', 'Jm2009!t', 6, '[’’USER’’]'),
(19, 'Bachiri', 'Behzad', 'behzad.bachiri@grandangle.fr', 'Bb2008%t', 6, '[’’USER’’]'),
(20, 'Lopes', 'Valentin', 'valentin.lopes@grandangle.fr', 'Vl2007&t', 6, '[’’USER’’]'),
(21, 'Aubry', 'Sam', 'sam.aubry@grandangle.fr', 'Sa2006!t', 6, '[’’USER’’]'),
(22, 'Armani', 'Pari', 'pari.armani@grandangle.fr', 'Pa2005%t', 6, '[’’USER’’]'),
(23, 'Blanc', 'Mariam', 'mariam.blanc@grandangle.fr', 'Mb2004&t', 6, '[’’USER’’]'),
(24, 'Sharifi', 'Leila', 'leila.sharifi@grandangle.fr', 'Ls2003!t', 6, '[’’USER’’]'),
(25, 'Safavi', 'Mahsa', 'mahsa.safavi@grandangle.fr', 'Ms2002%t', 6, '[’’USER’’]'),
(26, 'Klein', 'Justine', 'justine.klein@grandangle.fr', 'Jk2001%t', 7, '[’’USER’’]'),
(27, 'Traore', 'Ousmane', 'ousmane.traore@grandangle.fr', 'Ot2000&t', 7, '[’’USER’’]'),
(28, 'Rosay', 'Biggie', 'biggie.rosay@grandangle.fr', 'Br1999!t', 7, '[’’USER’’]'),
(29, 'Sakharov', 'Helena', 'helena.sakharov@grandangle.fr', 'Hs1998%t', 7, '[’’USER’’]'),
(30, 'Gorbatchev', 'Vladimir', 'vladimir.gorbatchev@grandangle.fr', 'Vg1997&t', 7, '[’’USER’’]'),
(31, 'Potter', 'Rose', 'rose.potter@grandangle.fr', 'Rp1996!t', 7, '[’’USER’’]'),
(32, 'Macron', 'Thibault', 'thibault.macron@grandangle.fr', 'Tm1995M%t', 7, '[’’USER’’]');
...
CREATE TABLE `contenu` (
  ...
  `Auteur_Contenu` varchar(100) DEFAULT NULL,
  `libelle_contenu` varchar(100) DEFAULT NULL,
...
(242, 'This painting depicts a woman wearing a blue dressing gown, barefoot, she is seen from behind and curled up on a beige mattress.', 'Sherlock holmes', 'Annabel Sleeping', 47, 2),
(243, '\r\nDieses Gemälde zeigt eine Frau in einem blauen Morgenmantel, barfuß, von hinten zu sehen und auf einer beigen Matratze zusammengerollt.\r\n', 'Alex schneider', 'Annabel schlafend', 47, 3),
(244, 'این نقاشی زنی را در حالی که لباس شب آبی پوشیده است، برهنه پا، از پشت و روی یک تشک بژ نشسته می‌نشاند.', 'Shadi ahmani', ' آنابل خوابیده ', 47, 4),
(245, '这幅画描绘了一位穿着蓝色睡袍的女人，赤脚，从背后看，蜷缩在米色床垫上。', 'Huan lee', '年安娜贝尔睡着了', 47, 6),
...
CREATE TABLE `dirart` (
  `id_DirArt` int(11) NOT NULL,
  `nom_DirArt` varchar(100) DEFAULT NULL,
  `prenom_DirArt` varchar(100) DEFAULT NULL,
  `email_DirArt` varchar(100) DEFAULT NULL,
  `tel_DirArt` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `espace` (
  `Id_Espace` int(11) NOT NULL,
  `libelle_Espace` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `exposition_`
--

CREATE TABLE `exposition_` (
  `Id_Exposition` int(11) NOT NULL,
  `libelle_Exposition` varchar(255) DEFAULT NULL,
  `Date_Debut` date NOT NULL,
  `Date_Fin` date NOT NULL,
  `Horaires_Debut` time NOT NULL,
  `Horaires_Fin` time NOT NULL,
  `Nbre_Oeuvres` int(11) NOT NULL,
  `chemin_Plan` varchar(150) DEFAULT NULL,
  `chemin_Teaser` varchar(100) DEFAULT NULL,
  `id_Theme` int(11) NOT NULL,
  `Id_Artiste` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Déchargement des données de la table `exposition_`
--

INSERT INTO `exposition_` (`Id_Exposition`, `libelle_Exposition`, `Date_Debut`, `Date_Fin`, `Horaires_Debut`, `Horaires_Fin`, `Nbre_Oeuvres`, `chemin_Plan`, `chemin_Teaser`, `id_Theme`, `Id_Artiste`) VALUES
(1, 'Tempête en Iran - Abbas Attar', '2024-01-09', '2024-02-02', '10:00:00', '19:00:00', 10, NULL, NULL, 1, 2),
(2, 'Un homme à travers la guerre - Kave Golestan', '2024-01-09', '2024-02-02', '10:00:00', '19:00:00', 10, NULL, NULL, 1, 18),
(3, 'L\'image d\'une femme en Iran - Shirin Nashat', '2024-01-09', '2024-02-02', '10:00:00', '19:00:00', 10, NULL, NULL, 2, 4),
(4, 'Dans la distance entre deux points - Iran Darroudi', '2024-02-05', '2024-03-01', '10:00:00', '19:00:00', 10, NULL, NULL, 3, 1),
(5, 'Rien - Parviz Tanavoli', '2024-02-05', '2024-03-01', '10:00:00', '19:00:00', 5, NULL, NULL, 4, 10),
(6, 'Cadre de vie - Lucian Freud', '2024-03-04', '2024-03-29', '10:00:00', '19:00:00', 20, NULL, NULL, 5, 12),
(7, 'Sombre comme la nuit - Pierre Soulages', '2024-04-01', '2024-04-26', '10:00:00', '19:00:00', 10, NULL, NULL, 5, 24),
(8, 'Un regard nouveau - Bahman Mohasses', '2024-04-01', '2024-04-26', '10:00:00', '19:00:00', 5, NULL, NULL, 5, 22),
(9, 'Cafard et géopolitique - Mana Neyestani', '2024-04-29', '2024-05-25', '10:00:00', '19:00:00', 15, NULL, NULL, 6, 3),
(10, 'Vent de rebellion à Persepolis - Marjan Satrapi', '2024-04-29', '2024-05-25', '10:00:00', '19:00:00', 10, NULL, NULL, 7, 16),
(11, 'Confusion et double nationalité - Riad Sattouf', '2024-04-29', '2024-05-25', '10:00:00', '00:00:19', 10, NULL, NULL, 7, 15),
(12, 'Allégorie de la violence -Kara Walker', '2024-05-28', '2024-06-21', '10:00:00', '00:00:19', 10, NULL, NULL, 8, 5),
(13, 'Rencontre un sculpteur minimal - Robert Morris', '2024-05-28', '2024-06-21', '10:00:00', '19:00:00', 5, NULL, NULL, 9, 25),
(14, ' Nouvelle rencontre à Yu Chang - Chang Yu', '2024-06-25', '2024-07-19', '10:00:00', '19:00:00', 15, NULL, NULL, 5, 6),
(15, 'A la mémoire de Zao - Wou-Ki Zao', '2024-06-25', '2024-07-19', '10:00:00', '19:00:00', 5, NULL, NULL, 5, 7),
(16, 'Culture Luxe - Richard Orlinski', '2024-07-23', '2024-08-16', '10:00:00', '19:00:00', 5, NULL, NULL, 4, 9),
(17, 'Art et nature - Pierre-Jean Chabert', '2024-08-20', '2024-09-13', '10:00:00', '19:00:00', 10, NULL, NULL, 4, 11),
(18, 'Joie à travers la couleur - Takashi Murakami', '2024-08-20', '2024-09-13', '10:00:00', '19:00:00', 15, NULL, NULL, 5, 8),
(19, 'Koons pop - Jeff Koons', '2024-09-17', '2024-10-11', '10:00:00', '19:00:00', 10, NULL, NULL, 11, 13),
(20, 'Redéfinition du noir et blanc - Santiago Sierra', '2024-10-15', '2024-11-08', '10:00:00', '19:00:00', 10, NULL, NULL, 1, 23),
(21, 'Prophétie mélancolique- Guity Novin', '2024-10-15', '2024-11-08', '10:00:00', '19:00:00', 5, NULL, NULL, 5, 19),
(22, 'Les souvenirs de Reza - Reza Deghati', '2024-10-15', '2024-11-08', '10:00:00', '19:00:00', 10, NULL, NULL, 1, 17),
(23, 'Dialogue interdit - Annette Messager', '2024-11-12', '2024-11-22', '10:00:00', '19:00:00', 5, NULL, NULL, 13, 20),
(24, 'Les frères Petgar - Jafar Petgar', '2024-11-26', '2024-12-20', '10:00:00', '19:00:00', 5, NULL, NULL, 5, 27),
(25, 'Les frères Petgar -Ali Asghar Petgar', '2024-11-26', '2024-12-20', '10:00:00', '19:00:00', 5, NULL, NULL, 5, 26);
...
CREATE TABLE `image` (
  ...
  `libelle_Image` varchar(50) DEFAULT NULL,
...
(1, 'mollah', '/artwork/attar_mollah.jpg', 1),
(2, 'United States Embassy', '/artwork/attar_usa_embassy.jpg', 2),
(3, 'money', '/artwork/attar_money.jpg', 3),
(4, 'khomeiny', '/artwork/attar_khomeiny.jpg', 4),
(5, 'shah', '/artwork/attar_shah.jpg', 5),
(6, 'revolution', '/artwork/attar_revolution.jpg', 6),
(7, 'fire', '/artwork/attar_fire.jpg', 7),
(8, 'shoe', '/artwork/attar_shoe.jpg', 8),
(9, 'attar_run', '/artwork/attar_run.jpg', 9),
(10, 'hoveyda', '/artwork/attar_hoveyda.jpg', 10),
(11, 'soldier', '/artwork/golestan_soldier.jpg', 11),
(12, 'water', '/artwork/golestan_water.jpg', 12),
(13, 'mullah', '/artwork/golestan_mullah.jpg', 13),
(14, 'streetwar', '/artwork/golestan_streetwar.jpg', 14),
(15, 'warprisoner', '/artwork/golestan_warprisoner.jpg', 15),
(16, 'martyr', '/artwork/golestan_martyr.jpg', 16),
(17, 'shah', '/artwork/golestan_shah.jpg', 17),
(18, 'streetwar2', '/artwork/golestan_streetwar2.jpg', 18),
(19, 'mask', '/artwork/golestan_mask.jpg', 19),
(20, 'irakwar', '/artwork/golestan_irakwar.jpg', 20),
(21, 'Mains musulmanes et juives', '/artwork/neshat_hands.jpg', 21),
(22, 'hand', '/artwork/neshat_hand.jpg', 22),
(23, 'rebellioussilence', '/artwork/neshat_rebellioussilence.jpg', 23),
(24, 'secret', '/artwork/neshat_secret.jpg', 24),
(25, 'aim', '/artwork/neshat_aim.jpg', 25),
(26, 'mother', '/artwork/neshat_mother.jpg', 26),
(27, 'stripped', '/artwork/Neshat-stripped.jpg', 27),
(28, 'unveiling', '/artwork/neshat_unveiling.jpg', 28),
(29, 'foot', '/artwork/neshat_foot.jpg', 29),
(30, 'martyrdom', '/artwork/neshat_martyrdom.jpg', 30),
(31, 'desert', '/artwork/darroudi_desert.jpg', 31),
(32, 'growing', '/artwork/darroudi_growing.jpg', 32),
(33, 'light', '/artwork/darroudi_light.jpg', 33),
(34, 'cold', '/artwork/darroudi_cold.jpg', 34),
(35, '', 'darroudi_illusion.jpg', 35),
...
CREATE TABLE `oeuvres` (
  `id_oeuvres` int(11) NOT NULL,
  `libelle_Oeuvre` varchar(150) NOT NULL,
  ...
  `chemin_Flashcode` varchar(250) DEFAULT NULL,
  `etat_Oeuvre` tinyint(1) DEFAULT NULL,
  `Consultation_Oeuvre` int(11) DEFAULT NULL,
...
INSERT INTO `oeuvres` (`id_oeuvres`, `libelle_Oeuvre`, `hauteur_Oeuvre`, `largeur_Oeuvre`, `profondeur_Oeuvre`, `poids_Oeuvre`, `prix`, `chemin_Flashcode`, `etat_Oeuvre`, `Consultation_Oeuvre`, `Id_Position`, `Id_Type`, `Id_Artiste`) VALUES
(1, 'mollah', '70.00', '50.00', '5.00', '800.00', '1000.00', '', 0, 0, 1, 1, 2),
(2, 'United States Embassy', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 1, 1, 2),
(3, 'Money', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 1, 1, 2),
(4, 'Khomeiny', '70.00', '50.00', '5.00', '800.00', '1000.00', '', 1, 0, 1, 1, 2),
(5, 'Shah', '70.00', '50.00', '5.00', '800.00', '1000.00', '', 1, 0, 1, 1, 2),
(6, 'Revolution', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 1, 1, 2),
(7, 'Fire', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 1, 1, 2),
(8, 'Shoes', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 1, 1, 2),
(9, 'Run', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 1, 1, 2),
(10, 'Hoveyda', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 1, 1, 2),
(11, 'Soldier', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 2, 1, 18),
(12, 'Water', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 2, 1, 18),
(13, 'Mullah', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 2, 1, 18),
(14, 'Street war', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 2, 1, 18),
(15, 'War prisoner', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 2, 1, 18),
(16, 'Martyr', '70.00', '50.00', '5.00', '800.00', '1000.00', '', 1, 0, 2, 1, 18),
(17, 'Shah', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 2, 1, 18),
(18, 'Street war 2', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 2, 1, 18),
(19, 'Mask', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 2, 1, 18),
(20, 'Irak War', '50.00', '70.00', '5.00', '800.00', '1000.00', '', 1, 0, 2, 1, 18),
(21, 'Hands', '18.00', '12.00', '5.00', '800.00', '1000.00', '', 1, 0, 3, 1, 4),
(22, 'Muslim Hand', '18.00', '12.00', '5.00', '800.00', '1000.00', '', 1, 0, 3, 1, 4),
(23, 'Rebellious Silence', '18.00', '12.00', '5.00', '800.00', '1000.00', '', 1, 0, 3, 1, 4),
(24, 'Secret', '18.00', '12.00', '5.00', '800.00', '1000.00', '', 1, 0, 3, 1, 4),
(25, 'Aim', '18.00', '12.00', '5.00', '800.00', '1000.00', '', 1, 0, 3, 1, 4),
(26, 'Mother and son', '18.00', '12.00', '5.00', '800.00', '1000.00', '', 1, 0, 3, 1, 4),
(27, 'Stripped', '18.00', '12.00', '5.00', '800.00', '1000.00', '', 1, 0, 3, 1, 4),
(28, 'Unveiling', '18.00', '12.00', '5.00', '800.00', '1000.00', '', 1, 0, 3, 1, 4),
(29, 'Foot', '18.00', '12.00', '5.00', '800.00', '1000.00', '', 1, 0, 3, 1, 4),
(30, 'Martyr Dom', '18.00', '12.00', '5.00', '800.00', '1000.00', '', 1, 0, 3, 1, 4),
(31, 'Desert', '135.00', '135.00', '5.00', '800.00', '8000.00', '', 1, 0, 1, 2, 1),
(32, 'Growing', '140.00', '140.00', '5.00', '800.00', '10000.00', '', 1, 0, 1, 2, 1),
(33, 'Light', '118.00', '89.00', '5.00', '800.00', '9000.00', '', 1, 0, 1, 2, 1),
(34, 'Cold', '73.00', '62.00', '5.00', '800.00', '9000.00', '', 1, 0, 1, 2, 1),
(35, 'Illusion', '56.00', '49.00', '5.00', '800.00', '9000.00', '', 1, 0, 1, 2, 1),
(36, 'Broken Sun', '130.00', '90.00', '5.00', '800.00', '9000.00', '', 1, 0, 1, 2, 1),
(37, 'Infinity', '123.00', '92.00', '5.00', '800.00', '9000.00', '', 1, 0, 1, 2, 1),
(38, 'Awake', '101.00', '60.00', '5.00', '800.00', '9000.00', '', 1, 0, 1, 2, 1),
(39, 'Stone Leaf Earth', '120.00', '80.00', '5.00', '800.00', '9000.00', '', 1, 0, 1, 2, 1),
(40, 'Stupor of the pain', '89.00', '118.00', '5.00', '5000.00', '10000.00', '', 1, 0, 1, 2, 1),
(41, 'Standing Heech', '106.00', '30.00', '25.00', '5000.00', '15000.00', '', 1, 0, 2, 3, 10),
(42, 'Heech lovers', '180.00', '122.00', '76.00', '5000.00', '60000.00', '', 1, 0, 2, 3, 10),
(43, 'Heech and chair VI', '18.00', '7.00', '7.00', '2000.00', '60000.00', '', 1, 0, 2, 3, 10),
(44, 'Heech in the cage', '118.00', '49.00', '42.00', '5000.00', '60000.00', '', 1, 0, 2, 3, 10),
(45, 'Heech twist', '815.00', '7.00', '6.00', '3000.00', '20000.00', '', 1, 0, 2, 3, 10),
(46, 'Hotel Bedroom', '70.00', '50.00', '5.00', '800.00', '1000.00', '', 1, 0, 1, 2, 12),
(47, 'Red Haired on a chair', '92.00', '92.00', '5.00', '800.00', '10000.00', '', 1, 0, 1, 2, 12),
(48, 'Annabel Sleeping', '39.00', '56.00', '5.00', '500.00', '5000.00', '', 1, 0, 1, 2, 12),
(49, 'Woman with a tulip', '13.00', '23.00', '5.00', '300.00', '1000.00', '', 1, 0, 1, 2, 12),
(50, 'The village boys', '41.00', '51.00', '5.00', '300.00', '1000.00', '', 1, 0, 1, 2, 12),
(51, 'Box of Apples in Wales', '75.00', '60.00', '5.00', '300.00', '1000.00', '', 1, 0, 2, 2, 12),
(52, 'Daffodils and Celery', '92.00', '92.00', '5.00', '800.00', '10000.00', '', 1, 0, 2, 2, 12),
(53, 'Girl with a kitten', '30.00', '40.00', '5.00', '300.00', '1000.00', '', 1, 0, 2, 2, 12),
(54, 'Girl Reading', '16.00', '30.00', '5.00', '300.00', '1000.00', '', 1, 0, 2, 2, 12),
(55, 'The painter\'s mother resting', '92.00', '92.00', '5.00', '800.00', '10000.00', '', 1, 0, 2, 2, 12),
(56, 'Rose and Sweet Pea', '92.00', '92.00', '5.00', '800.00', '10000.00', '', 1, 0, 3, 2, 12),
(57, 'Girl with Roses', '75.00', '106.00', '5.00', '800.00', '12000.00', '', 1, 0, 3, 2, 12),
(58, 'Strawberries', '13.00', '11.00', '5.00', '800.00', '2000.00', '', 1, 0, 3, 2, 12),
(59, 'Baby On a green sofa', '17.00', '25.00', '5.00', '300.00', '1000.00', '', 1, 0, 3, 2, 12),
(60, 'Girl in Bed', '31.00', '46.00', '5.00', '300.00', '1000.00', '', 1, 0, 3, 2, 12),
(61, 'Girl in a White dress', '48.00', '58.00', '5.00', '300.00', '1000.00', '', 1, 0, 3, 2, 12),
(62, 'Child with a toy dog', '40.00', '35.00', '5.00', '300.00', '1000.00', '', 1, 0, 3, 2, 12),
(63, 'Michael Andrews and June', '70.00', '60.00', '5.00', '300.00', '1000.00', '', 1, 0, 3, 2, 12),
(64, 'A Filly', '27.00', '19.00', '5.00', '300.00', '1000.00', '', 1, 0, 3, 2, 12),
(65, 'The painter\'s mother reading', '51.00', '66.00', '5.00', '300.00', '1000.00', '', 1, 0, 3, 2, 12);
...
CREATE TABLE `service` (
  `Id_Service` int(11) NOT NULL,
  `libelle_Service` varchar(80) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `theme_exposition` (
  `id_Theme` int(11) NOT NULL,
  `libelle_Theme` varchar(150) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `video` (
  `id_Video` int(11) NOT NULL,
  `libelle_Video` varchar(50) DEFAULT NULL,
  `chemin_Video` varchar(255) DEFAULT NULL,
  `libelle_Langue` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `_position`
--

CREATE TABLE `_position` (
  `Id_Position` int(11) NOT NULL,
  `libelle_Position` varchar(100) DEFAULT NULL,
  `Id_Espace` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Déchargement des données de la table `_position`
--

INSERT INTO `_position` (`Id_Position`, `libelle_Position`, `Id_Espace`) VALUES
(1, 'ES3-A-1', 4),
(2, 'ES3-A-2', 4),
(3, 'ES3-A-3', 4),
(4, 'ES3-A-4', 4),
...
ALTER TABLE `audio`
  ...
  ADD KEY `libelle_Langue` (`libelle_Langue`);

--
-- Index pour la table `bio_artist`
--
...
ALTER TABLE `collaborateur`
  ...
  ADD UNIQUE KEY `Email_Collaborateur` (`Email_Collaborateur`),
...
ALTER TABLE `contenir`
  ADD PRIMARY KEY (`Id_Exposition`,`Id_Espace`),
...
ALTER TABLE `contenu`
  ...
  ADD KEY `Id_Langue` (`Id_Langue`),
  ADD KEY `libelle_Langue` (`id_oeuvres`),
  ADD KEY `libelle_Langue_2` (`id_oeuvres`),
  ADD KEY `id_oeuvres` (`id_oeuvres`);

--
-- Index pour la table `dirart`
--
ALTER TABLE `dirart`
  ADD PRIMARY KEY (`id_DirArt`);
...
--
-- Index pour la table `exposition_`
--
ALTER TABLE `exposition_`
...
--
ALTER TABLE `gérer`
  ADD PRIMARY KEY (`id_Collaborateur`,`Id_Exposition`),
...
--
-- Index pour la table `préparer`
--
ALTER TABLE `préparer`
  ADD PRIMARY KEY (`id_Collaborateur`,`id_Contenu`),
  ADD KEY `id_Contenu` (`id_Contenu`);

--
-- Index pour la table `présenter_3`
--
ALTER TABLE `présenter_3`
  ADD PRIMARY KEY (`Id_Langue`,`id_Audio`),
  ADD KEY `id_Audio` (`id_Audio`);

--
-- Index pour la table `présenter_4`
--
...
--
-- Index pour la table `theme_exposition`
--
ALTER TABLE `theme_exposition`
...
--
ALTER TABLE `artiste`
  MODIFY `Id_Artiste` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
-- AUTO_INCREMENT pour la table `bio_artist`
--
ALTER TABLE `bio_artist`
  MODIFY `Id_bio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;

--
-- AUTO_INCREMENT pour la table `collaborateur`
--
ALTER TABLE `collaborateur`
  MODIFY `id_Collaborateur` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT pour la table `contenu`
--
ALTER TABLE `contenu`
  MODIFY `id_Contenu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=331;

--
-- AUTO_INCREMENT pour la table `dirart`
--
ALTER TABLE `dirart`
  MODIFY `id_DirArt` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `espace`
--
ALTER TABLE `espace`
  MODIFY `Id_Espace` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `exposition_`
--
ALTER TABLE `exposition_`
  MODIFY `Id_Exposition` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `oeuvres`
  MODIFY `id_oeuvres` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
-- AUTO_INCREMENT pour la table `_position`
--
ALTER TABLE `_position`
  MODIFY `Id_Position` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;
...
--
ALTER TABLE `audio`
  ADD CONSTRAINT `audio_ibfk_1` FOREIGN KEY (`libelle_Langue`) REFERENCES `oeuvres` (`id_oeuvres`);
...
--
ALTER TABLE `contenir`
  ADD CONSTRAINT `contenir_ibfk_1` FOREIGN KEY (`Id_Exposition`) REFERENCES `exposition_` (`Id_Exposition`),
...
--
-- Contraintes pour la table `exposition_`
--
ALTER TABLE `exposition_`
  ADD CONSTRAINT `exposition__ibfk_1` FOREIGN KEY (`id_Theme`) REFERENCES `theme_exposition` (`id_Theme`),
  ADD CONSTRAINT `exposition__ibfk_2` FOREIGN KEY (`Id_Artiste`) REFERENCES `artiste` (`Id_Artiste`);
...
ALTER TABLE `gérer`
  ...
  ADD CONSTRAINT `gérer_ibfk_2` FOREIGN KEY (`Id_Exposition`) REFERENCES `exposition_` (`Id_Exposition`);
...
--
ALTER TABLE `oeuvres`
  ADD CONSTRAINT `oeuvres_ibfk_1` FOREIGN KEY (`Id_Position`) REFERENCES `_position` (`Id_Position`),
  ADD CONSTRAINT `oeuvres_ibfk_2` FOREIGN KEY (`Id_Type`) REFERENCES `type_oeuvre` (`Id_Type`),
  ADD CONSTRAINT `oeuvres_ibfk_3` FOREIGN KEY (`Id_Artiste`) REFERENCES `artiste` (`Id_Artiste`);
...
--
ALTER TABLE `video`
  ADD CONSTRAINT `video_ibfk_1` FOREIGN KEY (`libelle_Langue`) REFERENCES `oeuvres` (`id_oeuvres`);

--
-- Contraintes pour la table `_position`
--
ALTER TABLE `_position`
  ADD CONSTRAINT `_position_ibfk_1` FOREIGN KEY (`Id_Espace`) REFERENCES `espace` (`Id_Espace`);
COMMIT;
