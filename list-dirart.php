...
$title = "Liste des directeurs artistiques";
    ...
    <div class="table-artiste">
      <table class="list-artiste" >
        ...
        <?php foreach ($dirArts as $dir) : ?>
          <tr>
            <td><?php echo $dir['id_DirArt'];?></td>
            <td><?php echo $dir['nom_DirArt'];?></td>
            <td><?php echo $dir['prenom_DirArt'];?></td>
            <td><?php echo $dir['tel_DirArt'];?></td>
            <td><?php echo $dir['email_DirArt'];?></td>
            <td>
