        ...
        <ul>
            <div class="menu-items">
                <div class="items">
                    ...
                    <span class="hidden-items show"><a href="list-exposition.php">Expositions</a></span>
                </div>
                <div class="items">
                    <li>
                        <a href="">
                    ...
                    <span class="hidden-items show"><a href="list-artist.php">Artistes</a></span> 
                </div>
                <div class="items">
                    <li>
                        <a href="">
                    ...
                    <span class="hidden-items show"><a href="list-art.php">Oeuvres<a/></span>
                ...
                <div class="items">
                    ...
                    <span class="hidden-items show"><a href="implant.php">Implantation</a></span>
                ...
                <div class="items">
                    ...
                    <span class="hidden-items show"><a href="">Collaborateurs</a></span>
                </div>
                 <!-- <?php endif;?>  -->
            </div>  
        </ul>
