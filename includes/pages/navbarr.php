        ...
        <ul>
            <div class="menu-items">
                <div class="items">
                    ...
                    <span class="hidden-items show"><a>Expositions</a></span>
                </div>
                <div class="items">
                    <li>
                        <a href="">
                    ...
                    <span class="hidden-items show"><a>Artistes</a></span> 
                </div>
                <div class="items">
                    <li>
                        <a href="">
                    ...
                    <span class="hidden-items show"><a>Oeuvres<a/></span>
                ...
                <div class="items">
                    ...
                    <span class="hidden-items show"><a>Implantation</a></span>
                ...
                <div class="items">
                    ...
                    <span class="hidden-items show"><a>Collaborateurs</a></span>
                </div>
                <!-- <?php endif;?> -->
            </div>  
        </ul>
