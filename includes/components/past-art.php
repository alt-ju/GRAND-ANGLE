...
$sqlArtPast = "SELECT oeuvres.Id_oeuvre, oeuvres.libelle_Oeuvre, Image.chemin_Image, artiste.Nom_Artiste, artiste.Prenom_Artiste, exposition.Date_Debut, exposition.Date_Fin, exposition.libelle_Exposition
FROM oeuvres 
...
<div class="art-content-now">
    ...
    <div class="expo-content-now">
        <div class="container-cards-art-now">
                ...
                <div class="card-art-now-expo" id="<?= $oeuvrePast['Id_oeuvre'] ?>">

                    <div class="delete-panel" id="delete-project-overlay-<?= $oeuvrePast['Id_oeuvre'] ?>">
                        <div class="container-delete">
                            <div class="info-delete">
                                <p>Voulez-vous vraiment supprimer l'oeuvre ?</p>
                                <div>
                                    <button id="confirm-delete" data-oeuvre-id="<?= $oeuvrePast['Id_oeuvre']?>">Oui, supprimer</button>
                        ...
                        <div class="content-infos-oeuvre-ongoing">
                            ...
                            <div class="action-oeuvre-ongoing">
                                <div class="modify-art-ongoing">
                                    <a href="oeuvre-update.php?id=<?= $oeuvrePast['Id_oeuvre']?>">
                                ...
                                <div class="delete-art-ongoing">
                                    <a href="#" class="delete-oeuvre-link link" data-id="<?= $oeuvrePast['Id_oeuvre']?>">
