<div class="art-content-next">
    <div class="card-art-next">
        <div class="titles-art-next">
            <div class="title-libelle-next">
                <h2>Libellé de l'exposition</h2>
            </div>
            <div class="date-expo-next">
                <p>Date de début et de fin</p>
            </div>
        </div>
        <div class="scroll-container">
            <div class="art-artists-next">
                <p>Artiste</p>
                <ul>
                    <li>Oeuvre 1</li>
                </ul>
