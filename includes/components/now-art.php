...
$sqlArtNow = "SELECT oeuvres.Id_oeuvre, exposition.libelle_Exposition, oeuvres.libelle_Oeuvre, Image.chemin_Image, artiste.Nom_Artiste, artiste.Prenom_Artiste
FROM oeuvres 
                    ...
                    <div class="card-row2">
                        ...
                        <div class="content-infos-oeuvre-ongoing">
                            ...
                            <div class="action-oeuvre-ongoing">
                                ...
                                <a href="oeuvre-update.php?id=<?= $oeuvreNow['Id_oeuvre'];?>">
